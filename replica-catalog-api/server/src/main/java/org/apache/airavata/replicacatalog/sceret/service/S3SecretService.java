...
import org.apache.airavata.replicacatalog.secret.service.s3.S3SecretServiceGrpc;
...
@GRpcService
public class S3SecretService extends S3SecretServiceGrpc.S3SecretServiceImplBase {

    private static final Logger logger = LoggerFactory.getLogger(S3SecretService.class);
