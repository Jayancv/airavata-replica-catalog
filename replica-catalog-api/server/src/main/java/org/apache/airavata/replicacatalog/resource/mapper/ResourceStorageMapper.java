...
public class ResourceStorageMapper {
    ...
    public void mapGenericStorageEntityToModel(GenericResourceEntity resourceEntity, GenericResource.Builder dataProductBuilder) {

        dataProductBuilder.setResourceId( resourceEntity.getResourceId() );
    }
